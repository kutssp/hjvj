...
Чтобы выйти из заклинания иллюзии смены пола и позволить иллюзии исчезнуть, вы можете использовать следующие методы:
